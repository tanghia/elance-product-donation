...
*/
class SpringSecurityOauthLinkedinGrailsPlugin {
    def version = "0.1"
    ...
    def description = '''\
Integrate [LinkedIn|http://www.linkedin.com] to [Spring Security OAuth plugin|http://grails.org/plugin/spring-security-oauth].
'''

    def documentation = "https://github.com/donbeave/grails-spring-security-oauth-linkedin"
    ...
    def scm = [url: 'https://github.com/donbeave/grails-spring-security-oauth-linkedin']
