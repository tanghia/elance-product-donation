...
grails {
	mail {
	  host = "smtp.gmail.com"
	  port = 465
	  username = "pagetestweb@gmail.com"
	  password = "elanceuser"
...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'productdonation.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'productdonation.UserRole'
grails.plugin.springsecurity.authority.className = 'productdonation.Role'
grails.plugin.springsecurity.requestMap.className = 'productdonation.RequestMap'
