...
<div
	...
	<label for="username"> Email <span class="required-indicator">*</span>
	</label>
...
<div
	class="fieldcontain ${hasErrors(bean: userInstance, field: 'phoneNumber', 'error')} required form-group">
	<label for="phoneNumber"> <g:message
			code="user.phoneNumber.label" default="Phone Number" /> <span
...
<%--
	<div
		class="fieldcontain ${hasErrors(bean: userInstance, field: 'createdDate', 'error')} form-group">
		<label for="createdDate"> <g:message
				code="user.createdDate.label" default="Created Date" />

		</label>
		<g:datePicker name="createdDate" precision="day"
			value="${userInstance?.createdDate}" default="none"
